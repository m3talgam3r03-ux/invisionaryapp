...
| Funnel | La **pagina pubblica** che raccoglie contatti — l'unica porta dell'app senza login, e per questo la più esposta. C'è il modulo vero: compilalo e il contatto entra nel CRM col consenso registrato. Poi prova i cinque pulsanti **«Prova i filtri»**: campo civetta, invio in mezzo secondo, nessuna spunta, nessun recapito, limite orario superato — tutti respinti, e nessuno finisce fra i contatti. Il consenso è **una spunta per canale**: chi acconsente all'email non ha acconsentito a WhatsApp. Di ogni contatto resta **copia del testo accettato**, non un riferimento (visibile solo a leader e admin) |
